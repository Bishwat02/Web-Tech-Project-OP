    ...
    <div class="footer">
        ...
        <div class="bottom">
            ...
            <div class="social">
                ...
                <a href="https://www.instagram.com/" class="custom-icon">
            ...
            <div class="share">
                ...
                <a href="https://www.apple.com/my/app-store/" class="custom-icon">
                    <img src="../assets/images/AppStore.png" alt="App Store">
                </a>
                <a href="https://play.google.com/store/games" class="custom-icon">
                    <img src="../assets/images/GooglePlay.png" alt="Google Play">
                </a>
            </div>  
        
            <p>&copy; <a href="https://bootstrapstarter.com/bootstrap-templates/template-fooddelivery-bootstrap-html/"></a> 2024 OP Restaurant</p>
        </div>
