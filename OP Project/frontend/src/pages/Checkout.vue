        ...
        <div class="checkout-form-container">
            <form id="checkoutForm" @submit="handleSubmit" novalidate autocomplete="off">
                <div class="checkout-heading">
                    ...
                    <h3 v-if="user">{{ user.user_name }}'s Order<span>RM{{ calculateSummaryPrice()[3] }}</span></h3>
                </div>
                ...
                <div class="form-group details-group">
                    ...
                    <div class="form-group">
                        <input type="text" name="coAddress" id="coAddress" placeholder="Address in Subang Jaya, Selangor"
    ...
    methods: {
        ...
        checkForm: function () {
            ...
            if (!this.checkoutObj.phone) {
                ...
                if (!this.checkoutObj.phone.startsWith('60')) {
                    this.errorObj.phoneErr.push('Phone numbers must start with 60');
                }
