    ...
    <section class="order-section">
        ...
        <div class="icons-container">
            ...
            <div class="icons">
                ...
                <h3>22A, Jalan USJ 20/6H, USJ 20, 47630, Subang Jaya, Selangor</h3>
            </div>
    ...
    methods: {
        ...
        checkForm: function () {
            ...
            if (!this.orderObj.phone) {
                ...
                if (!this.orderObj.phone.startsWith('60')) {
            ...
            if (!this.orderObj.when) {
                ...
                if (dateInput.getHours() < 7 || dateInput.getHours() > 22) {
                    this.errorObj.whenErr.push("Store open from 10:00 AM to 10:00 PM everyday");
                }
            }
