                                ...
                                <div v-for="(f, index) in filterFoods" :key="index">
                                    <div class="box-content row">
                                        ...
                                        <div class="item-price col-sm-1">
                                            <span class="sale-price">RM{{ parseFloat(f.food_price) -
                    ...
                    <div class="col-md-3">
                        <div class="box">
                            ...
                            <div class="box-content">
                                <span>Summary</span>
                                <h3 class="font-bold total-first-price">RM{{ calculateSummaryPrice()[0] }}</h3>

                                <span>Discount</span>
                                <h3 class="font-bold total-discount">RM{{ calculateSummaryPrice()[1] }}</h3>

                                <span>Delivery fee</span>
                                <h3 class="font-bold total-delivery">RM{{ calculateSummaryPrice()[2] }}</h3>

                                <hr />

                                <span>Total</span>
                                <h2 class="font-bold total-sale">RM{{ calculateSummaryPrice()[3] }}</h2>
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i>+60 108078735</h3>
                                <span class="small">
                                    Please contact with us if you have any questions. We are avalaible from 10:00am to 10:00pm, everyday.
                                </span>
                            </div>
                        </div>
                    </div>
